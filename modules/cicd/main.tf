...
resource "aws_codebuild_project" "main" {
  ...
  environment {
    ...
    environment_variable {
      ...
      value = join(",", var.ecr_repositories)
    }
  }
...
# CodePipeline (if GitHub is configured)
resource "aws_codepipeline" "main" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        Owner                = split("/", replace(var.github_repo, "https://github.com/", ""))[0]
        Repo                 = split("/", replace(var.github_repo, "https://github.com/", ""))[1]
